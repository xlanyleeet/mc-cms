...
async function middleware(req) {
    ...
    if (req.nextUrl.pathname.startsWith("/admin") && token?.role !== "user") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/auth/signin", req.url));
    }
